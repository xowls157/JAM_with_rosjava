...
public class FunctionGetExceptionCause extends AbstractExceptionFunction {
	@Override
	public String getName() {
		return "exGetExceptionCause";
	}
	...
	public Value _execute(Interpreter i, Goal g, Binding b,
		...
		AgentRuntimeException cause = ex.cause();
		return new Value(cause);
	}
}